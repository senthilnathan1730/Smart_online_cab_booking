...
<div class="text-center mb-8">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
    ...
    <div class="bg-white shadow-lg rounded-xl p-4">
      ...
      <form action="round-booking-summary.php" method="POST" class="mt-4 text-center">
        <input type="hidden" name="r_car" value="Sedan">
        <input type="hidden" name="r_price" value="12/km">
    ...
    <div class="bg-white shadow-lg rounded-xl p-4">
      ...
      <form action="round-booking-summary.php" method="POST" class="mt-4 text-center">
        <input type="hidden" name="r_car" value="SUV">
        <input type="hidden" name="r_price" value="15/km">
        <button type="submit" class="bg-red-600 text-white px-5 py-2 rounded-full hover:bg-red-700">Book Now</button>
      </form>
    </div>
    ...
    <div class="bg-white shadow-lg rounded-xl p-4">
      ...
      <form action="round-booking-summary.php" method="POST" class="mt-4 text-center">
        <input type="hidden" name="r_car" value="Innova">
        <input type="hidden" name="r_price" value="18/km">
        <button type="submit" class="bg-red-600 text-white px-5 py-2 rounded-full hover:bg-red-700">Book Now</button>
      </form>
    </div>
  </div>
